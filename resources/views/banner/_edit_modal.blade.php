                              ...
                              <div class="row justify-content-between" >
                                  ...
                                  <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="shop_id" name="shop_id"  data-placeholder="Select Shop..." required>
...
{{--                                  </div>--}}
                                  <div class="col-md-12">
                                      <img src="" alt="" srcset="" style="width:inherit">
                                    <fieldset class="form-group">
                                        <label for="storePANImage">Upload Banner Image </label>
                                        <div class="input-group" >
                                        <div class="input-group-prepend">
                                            <span class="input-group-text" id="storePANImage">Banner Image</span>
                                        </div>
                                        <div class="custom-file">
                                        <input type="file"  class="custom-file-input"  name="image" id="storePANImageUpload" aria-describedby="storePANImage" required>
