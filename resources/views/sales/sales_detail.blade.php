                    ...
                    <span>{{$order->cart->centre->user->mobile}}</span>
                        ...
                        <div class="invoice-product-details
                            ...
                            <div class="row justify-content-between">
                                <div class="col-md-6">
                                    <h2 class="card-title text-danger">Pending Orders List</h2>
                                </div>
                                <div class="col-md-6">
                                    <a href="{{ route('sales.detail', $shop->id) }}"
                                        class="btn btn-info float-right">Show Paid Orders</a>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-4 col-xl-4 col-sm-4 d-flex justify-content-between mt-75">
                                    <div class="invoice-subtotal w-75">
                                        ...
                                        <hr>
                                        <div class="invoice-calc d-flex justify-content-between text-danger">
                                            <span class="invoice-title">
                                                Pending Amount</span>
