      ...
      <div class="col-md-12">
        <div class="card">
          ...
          <div class="card-content">
            <div class="card-body">
                @if ($route[2] == 'create')
                <form action="{{route('demand.slots.store')}}" method="post">
                    @method('POST')
                @endif
                @if ($route[2] == 'edit')
                <form action="{{route('demand.slots.update', $slot->id)}}" method="post">
                    @method('PUT')
                @endif
                            ...
                            <div class="card-content">
                              <div class="card-body">
                                      <div class="row justify-content-between" >
                                          @role('admin')
                                          <div class="col-md-12">
                                              <?php $shop_id = null; if(isset($slot)){$shop_id = $slot->provider->id;}  ?>
                                                        ...
                                                        <div class="contact-repeater">
                                                          <div data-repeater-list="stocks">
                                                              <div class="row" data-repeater-item>
                                                                  ...
                                                                  <div class="col-md-3 form-group">
                                                                    <label for="">Max Booking</label>
                                                                    <input type="number" value="{{isset($slot->count) ? $slot->count : old('count')}}" class="form-control" name="count" placeholder="Count">
                                                                  </div>
