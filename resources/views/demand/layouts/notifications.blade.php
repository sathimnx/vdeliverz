<?php
 $demand_notifications = auth()->user() ? auth()->user()->unreadNotifications()->select('notifications.*')->where('data->demand', true)->take(5)->get() : []; ?>
        <li class="scrollable-container media-list" id="loadNotifications">
            @forelse($demand_notifications as $key => $notification)
                    <a class="d-flex justify-content-between" href="{{route('demand.bookings.show', $notification->data['admin_order_id'])}}">
                        <div class="media d-flex align-items-center">
                            ...
                            <div class="media-body">
                                <h6 class="media-heading">
                                    <span class="text-bold-500">New Booking Arrived!</span><br>
