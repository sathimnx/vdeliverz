  ...
  <body class="vertical-layout vertical-menu-modern semi-dark-layout 2-columns  navbar-sticky footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="2-columns" data-layout="semi-dark-layout">
        ...
        <div class="navbar-container content">
          <div class="navbar-collapse" id="navbar-mobile">
            ...
            <ul class="nav navbar-nav float-right">
                @role('admin')
                <li class="nav-item d-none d-lg-block m-auto text-center "><a href="{{route('analytics.index')}}" target="_blank" class="nav-link btn btn-outline-primary mr-3">Show Analytics</a></li>
              <li class="nav-item d-none d-lg-block m-auto text-center"><a href="{{ route('dashboard.index') }}" class="nav-link btn btn-light-primary">Go to Order and Delivery</a></li>
              @endrole
              ...
              <li class="dropdown dropdown-notification nav-item">
                <a class="nav-link nav-link-label"
                    href="#"
                    data-toggle="dropdown"><i class="ficon bx bx-bell bx-tada bx-flip-horizontal"></i><span class="badge badge-pill badge-danger badge-up" id="notifyCount">.</span></a>
            ...
            {{--                      <span class="notification-title">{{auth()->user()->unreadNotifications->count()}} new Notification</span><span class="text-bold-400 cursor-pointer"> </span>--}}
                    ...
                    {{-- @include('demand.layouts.notifications') --}}
                    <li class="dropdown-menu-footer">
                        <a
                            class="dropdown-item p-50 text-primary justify-content-center"
                            href="{{route('demand.bookings.index')}}"
                        >See all Bookings</a
                        >
                    </li>
                </ul>
              ...
              <div class="user-nav d-sm-flex d-none"><span class="user-name">{{Auth::user()->name}}</span><span class="user-status text-muted">Available</span></div><span><img class="round" src="{{asset(Auth::user()->image)}}" alt="avatar" height="40" width="40"></span></a>
                <div class="dropdown-menu dropdown-menu-right pb-0">
                    @role('admin')
                    <a class="dropdown-item" href="{{route('users.edit', Auth::user())}}"><i class="bx bx-user mr-50"></i>  Profile</a>
                    @else
                    <a class="dropdown-item" href="{{route('users.edit', Auth::user()->id)}}"><i class="bx bx-user mr-50"></i>  Profile</a>
                    @endrole
    ...
    <div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
      ...
      <div class="main-menu-content">
        ...
        <li class=" nav-item {{ $route[1] == 'dashboard' ? 'active' : ''}}"><a href="{{ route('demand.dashboard.index') }}"><i class="bx bx-home" data-icon="desktop"></i><span class="menu-title" data-i18n="Dashboard">Dashboard</span></a>
          </li>
          {{-- @can('view_roles')
          ...
          @endcan --}}
        @role('admin')
        <li class=" nav-item {{ $route[1] == 'users' ? 'active' : ''}}"><a href="{{route('demand.users.index')}}"><i class="bx bxs-group" data-icon="users"></i><span class="menu-title" data-i18n="Dashboard">Users</span></a>
        </li>
        @endrole
        @canany(['view_services', 'view_sub_services'])
        <li class=" navigation-header"><span>Services</span>
        </li>
        @endcanany
        @can('view_services')
         <li class=" nav-item {{ $route[1] == 'services' ? ' active' : '' }}"><a href="{{route('demand.services.index')}}"><i class="bx bx-task" data-icon="settings"></i><span class="menu-title" data-i18n="Form Layout">Service Category</span></a>
           </li>
           @endcan
           @can('view_sub-services')
           <li class=" nav-item {{ $route[1] == 'sub-services' ? ' active' : '' }}"><a href="{{route('demand.sub-services.index')}}"><i class="bx bxs-categories" data-icon="settings"></i><span class="menu-title" data-i18n="Form Layout">Services</span></a>
           </li>
           @endcan

        @can('view_providers')
                <li class=" navigation-header"><span>Service Providers</span>
                </li>
                @php $active = ($route[1] == 'providers') ? 'active' : ''; @endphp
              <li class=" nav-item {{ $active }}"><a href="{{route('demand.providers.index')}}"><i class="bx bx-sitemap" data-icon="envelope-pull"></i><span class="menu-title" data-i18n="Email">Providers</span></a>
                </li>
            @endcan

        @canany(['view_services', 'view_sub_services'])

          <li class=" navigation-header"><span>Car Rental</span>
          </li>
          @endcanany
          @can('view_cars')
        <li class=" nav-item {{ $route[1] == 'cars' ? ' active' : '' }}"><a href="{{ route('demand.cars.index') }}"><i class="bx bx-car" data-icon="settings"></i><span class="menu-title" data-i18n="Form Layout">Cars</span></a>
          </li>
          @endcan
          @can('view_car-provider')
          <li class=" nav-item {{ $route[1] == 'provider-cars' ? ' active' : '' }}"><a href="{{ route('demand.provider-cars.index') }}"><i class="bx bx-user-check" data-icon="settings"></i><span class="menu-title" data-i18n="Form Layout">Provider Cars</span></a>
            </li>
          @endcan
        ...
        @endcan
          ...
          <li class=" nav-item {{$active}}"><a href="{{route('products.index')}}"><i class="bx bxs-categories" data-icon="settings"></i><span class="menu-title" data-i18n="Form Layout">Products</span></a>
            </li>
          @endcan
            <li class=" nav-item {{ $route[0] == 'titles' ? ' active' : '' }}"><a href="{{route('titles.index')}}"><i class="bx bx-spreadsheet" data-icon="settings"></i><span class="menu-title" data-i18n="Form Layout">Topping Categories</span></a>
            </li>
          @can('view_product-categories')
          @php $active = ($route[0] == 'product-categories') ? 'active' : ''; @endphp
          <li class=" nav-item {{$active}}"><a href="{{route('product-categories.index')}}"><i class="bx bx-basket" data-icon="settings"></i><span class="menu-title" data-i18n="Form Layout">Product Categories</span></a>
            </li>
          @endcan
          @can('view_cuisines')
                @php $active = ($route[0] == 'cuisines') ? 'active' : ''; @endphp
          <li class=" nav-item {{$active}}"><a href="{{route('cuisines.index')}}"><i class="bx bxs-package" data-icon="priority-low"></i><span class="menu-title" data-i18n="Form Wizard">Cuisines</span></a>
              </li>
           @endcan
          @can('view_coupons')
        ...
        @can('view_addresses')
         ...
         {{-- <li class=" nav-item {{ $route[0] == 'addresses' ? ' active' : '' }}"><a href="{{route('addresses.index')}}"><i class="bx bx-map" data-icon="settings"></i><span class="menu-title" data-i18n="Form Layout">Address</span></a>
           </li> --}}

           @endcan
           @can('view_slots')
           <li class=" nav-item {{ $route[1] == 'slots' ? ' active' : '' }}"><a href="{{ route('demand.slots.index') }}"><i class="bx bx-time" data-icon="settings"></i><span class="menu-title" data-i18n="Form Layout">Slots</span></a>
           </li>
           @endcan
           {{-- @can('view_products')
              @php $active = ($route[0] == 'products') ? 'active' : ''; @endphp
        ...
        @endcan
         ...
         <li class=" nav-item {{ $route[0] == 'delivery-boys' ? ' active' : '' }}"><a href="{{route('delivery-boys.index')}}"><i class="bx bx-truck" data-icon="settings"></i><span class="menu-title" data-i18n="Form Layout">Delivery Boy</span></a>
          ...
          @can('view_bookings')
          <li class=" navigation-header"><span>Demand and Services</span>
            @php $active = ($route[1] == 'bookings') ? 'active' : ''; @endphp
            <li class=" nav-item {{$active}}"><a href="{{ route('demand.bookings.index') }}"><i class="bx bx-link" data-icon="warning-alt"></i><span class="menu-title" data-i18n="Sweet Alert">Bookings</span></a>
          </li>
          @endcan
          {{-- @can('view_delivery_boy_charge')
          @php $active = ($route[0] == 'manage-deliveries') ? 'active' : ''; @endphp
            <li class=" nav-item {{$active}}"><a href="{{route('manage-deliveries.index')}}"><i class="bx bx-map-pin" data-icon="warning-alt"></i><span class="menu-title" data-i18n="Sweet Alert">Delivery</span></a>
          </li>
            @php $active = ($route[0] == 'sales') ? 'active' : ''; @endphp
            <li class=" nav-item {{$active}}"><a href="{{route('sales.index')}}"><i class="bx bx-receipt" data-icon="warning-alt"></i><span class="menu-title" data-i18n="Sweet Alert">Sales</span></a>
          </li>
          </li>
          ...
          @endcan --}}
            ...
            <li class=" nav-item {{$active}}"><a href=""><i class="bx bx-truck" data-icon="warning-alt"></i><span class="menu-title" data-i18n="Sweet Alert">Delivered Orders</span></a>
          </li> --}}
      ...
      <div class="content-wrapper">
        <div class="content-header row">
          <div class="content-header-left col-12 mb-2 mt-1">
            @include('demand.layouts.breadcrump')
          </div>
        </div>
