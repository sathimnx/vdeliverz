            ...
            <div class="card-body pb-0 mx-25">
              ...
              <div class="row">
                <div class="col-xl-4 col-md-12">
                  ...
                  <span>#5876432{{$provider->id}}</span>
                </div>
                <div class="col-xl-8 col-md-12">
                  <div class="d-flex align-items-center justify-content-xl-end flex-wrap">
                    <div class="mr-3">
                      <small class="text-muted">Created Date:</small>
                      <span>{{\Carbon\Carbon::parse($provider->created_at)->format('d-m-Y H:i')}}</span>
                    </div>
                    <div>
                      <small class="text-muted">Status:</small>
                      <span class="{{$provider->active == 1 ? 'text-success' : 'text-danger'}}">( {{$provider->active == 1 ? 'Active' : 'Inactive'}} - </span>
                      <span class="{{$provider->opened == 1 ? 'text-success' : 'text-danger'}}">{{$provider->opened == 1 ? 'Opened' : "Closed"}} )</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="row my-3">
                <div class="col-6">
                  <h4 class="text-primary">{{$provider->name}}</h4>
                  <span>{{$provider->email}}</span><br>
                  <span>{{$provider->mobile}}</span>
                </div>
                <div class="col-6 d-flex justify-content-end">
                  <img src="{{$provider->image}}" alt="" width="30%">
                </div>
              </div>
              <hr>
              ...
              <div class="row invoice-info">
                <div class="col-md-4 mt-1">
                  ...
                  <div class="">
                    ...
                    <span>{{$provider->area}},</span><br>
                    <span>{{$provider->city}}</span><br>
                  </div>
                  {{-- <div class="">
                  ...
                  <div class="col-md-4 mt-1">
                      ...
                      <div class="">
                          <span><b>Weekdays :</b> {{$provider->weekdays}}</span>
                      </div>
                      <div class="mt-1">
                          <span><b>Time :</b> {{$provider->open_time}} - {{$provider->close_time}}</span>
                      </div>
{{--                      <div class="">--}}
...
{{--                      </div>--}}
                ...
                <div class="col-md-4 mt-1">
                  ...
                  <div class="">
                      <span><b>Name :</b> {{$provider->user->name}}</span>
                  </div>
                  <div class="">
                      <span><b>Email :</b> {{$provider->user->email}}</span>
                  </div>
                  <div class="">
                      <span><b>Mobile :</b> {{$provider->user->mobile}}</span>
                  </div>
                </div>
              </div>
              <hr>
            ...
            <div class="card-body pt-0 mx-25">
              ...
              <div class="row">
                <div class="col-4 col-xl-6 col-sm-4 mt-75">
                    <div class="invoice-subtotal">
                        <div class="invoice-calc d-flex justify-content-between">
                          {{-- <span class="invoice-title">Total Products : {{$provider->products_count}}</span> --}}
                ...
                <div class="col-4 col-xl-6 col-sm-4 d-flex justify-content-end mt-75">
                  <div class="invoice-subtotal">
                    <div class="invoice-calc d-flex justify-content-between">
                      <span class="invoice-title">Total Bookings Completed</span>
                    ...
                    <div class="invoice-calc d-flex justify-content-between">
                      <span class="invoice-title">Total Canceled Bookings</span>
                      {{-- <span class="invoice-value text-danger">{{$shop->canceled_count}}</span> --}}
                    </div>
                    <div class="invoice-calc d-flex justify-content-between">
                      <span class="invoice-title">Ratings</span>
