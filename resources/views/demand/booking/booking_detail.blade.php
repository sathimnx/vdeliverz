          ...
          <div class="card-content">
            <div class="card-body pb-0 mx-25">
                ...
                <div class="col-xl-8 col-md-12">
                  <div class="d-flex align-items-center justify-content-xl-end flex-wrap">
                    ...
                    <div>
                      ...
                      <span>{{\Carbon\Carbon::parse($booking->sheduled_at)->format('d-m-Y')}} - </span>
                      <span> {{$booking->from}} </span>
                      <span>( {{$booking->hours ?? 'Job Price'}}  )</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="row invoice-info justify-content-center">
                ...
                <div class="col-4">
                    <h4 class="invoice-to mb-2">Service Details</h4>
                  <div class="">
                    <span class="d-block mb-1"><strong>Service Name :</strong> {{ $booking->service_name }}</span>
                    <span class="d-block mb-1"><strong>Service Fair :</strong> {{ $booking->charge }} ₹</span>
                    <span class="d-block mb-1"><strong>Price Type :</strong> {{ $booking->hours ?? 'Job Price' }}</span>
                    <span class="d-block mb-1"><strong>Service Amount Total :</strong> {{ $booking->total_amount }} ₹</span>
                  </div>
                  </div>
                <div class="col-4">
