<div class="row justify-content-between" >
    ...
    <div class="col-md-6 col-12 form-group">
        ...
        <fieldset>
            <div class="radio radio-info radio-glow">
                <input type="radio" value="2" id="action3" name="action">
                <label for="action3">Accept</label>
            </div>
        </fieldset>
        @endif
    </div>
    <div class="col-md-6 col-12 form-group">
        ...
        <fieldset>
            <div class="radio radio-info radio-glow">
                <input type="radio" id="action2" value="6" name="action">
                <label for="action2">Completed</label>
            </div>
        </fieldset>
    ...
    <div class="col-md-6 col-12 form-group">
        ...
        <fieldset>
            <div class="radio radio-danger radio-glow">
                <input type="radio" id="action4" value="4" name="action">
