                ...
                @push('scripts')
                    <script>
                        function getRoleUsers(id, url){
                            if (id) {
                                window.location.href = url+'/demand/users/role/'+id;
                            } else {
                                window.location.href = url+'/demand/users/';
                            }
                        }
                    </script>
                @endpush
                ...
                <div class="card-text">
                    <h5 class="d-block card-text text-center mb-3">Total Users - {{$users->total()}}</h5>
                        <div class="row">
                            <div class="col-sm-6">
                                @can('create_users')
                                <a href="{{ route('demand.users.create') }}" class="btn btn-warning float-left" class="btn btn-primary">Create User</a>
                                @endcan
                            </div>
                        <div class="col-sm-6">
                            <div class="searchbar">
