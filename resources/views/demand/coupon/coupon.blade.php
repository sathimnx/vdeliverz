                ...
                <p class="card-text">
                    <h5 class="d-block card-text text-center mb-3">Total Coupons - {{$coupons->total()}}</h5>
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                @can('create_coupons')
                                <a href="{{ route('coupons.create') }}" class="btn btn-warning float-left" class="btn btn-primary">Create Coupon</a>
                                @endcan
                                ...
                                <tbody>
                                        @if(isset($coupons) && !empty($coupons))
                                            ...
                                            <tr>
                                                ...
                                                white-space: nowrap;" data-toggle="tooltip" data-placement="top" title="{{$item->coupon_description}}">{{ $item->coupon_description }}</td>
                                                <td>
