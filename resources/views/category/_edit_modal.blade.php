                              ...
                              <div class="row justify-content-between" >
                                  ...
                                  <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="shop_id" name="type_id"  data-placeholder="Select Shop..." >
                                  ...
                                  <div class="col-md-12">
                                    ...
                                    <fieldset class="form-group">
                                        ...
                                        <div class="input-group-prepend">
                                            <span class="input-group-text" id="storePANImage">Icon Image</span>
                                        </div>
                                ...
                                <div class="col-md-12">
                                  ...
                                  <fieldset class="form-group">
                                      ...
                                      <div class="custom-file">
                                      <input type="file"  class="custom-file-input"  name="banner" id="storePANImageUpload2" aria-describedby="storePANImage3">
