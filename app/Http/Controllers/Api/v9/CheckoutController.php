...
class CheckoutController extends Controller
{
    public function payment_initiate(Request $request){
        try {
            ...
            $cart_data = \App\Cart::where('id',$local_order->cart_id)->first();
            $coupon_discount = ($cart_data->vendorcoupon_amount == null || $cart_data->vendorcoupon_amount == '' ? 0 : $cart_data->vendorcoupon_amount);
            
            $total = round($local_order->amount - $coupon_discount,0);
