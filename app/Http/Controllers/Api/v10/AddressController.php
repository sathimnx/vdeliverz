...
class AddressController extends Controller
{
    ...
    {
        try {
            $addresses = Auth::user()->addresses()->withoutTrashed()->get(['id as address_id', 'address', 'landmark', 'type', 'latitude', 'longitude','google_address','area']);
    ...
    public function edit(Request $request)
    {
        try {
            ...
            $address = Address::where('id', $request->address_id)->where('user_id', Auth::user()->id)->first(['id as address_id', 'address', 'landmark', 'type', 'latitude', 'longitude','google_address','area']);
            if(!$address){
    ...
    public function update(Request $request, Address $address)
    {
        try {
            ...
            $address->google_address = isset($request->google_address) ? $request->google_address : null;
            $address->save();
