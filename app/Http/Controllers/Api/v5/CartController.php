      ...
      $coupon_code = $request->coupon_code;
       ...
       //  dd($coupon->shop_id,$coupon->sub_category_id,$coupon->product_id);
            if($coupon->shop_id > 0 || $coupon->sub_category_id > 0 || $coupon->product_id > 0)
            {
               ...
               $CouponCount = \App\Cart::where('user_id', $userId)->where('checkout', 0)->where('shop_id',$coupon->shop_id)
               ...
               if($CouponCount->count > 0) {
                 ...
                 $Products_subcategoryId = $coupon->sub_category_id == '0' ? \App\Product::where('shop_id', $coupon->shop_id)->get() :
